...
class BookingEventConsumerTest {
    ...
    void onPaymentSucceeded_extracts_paymentId_from_its_own_field() {
        ...
        verify(bookingService)
                .onPaymentSucceeded(BookingTestData.EVENT_ID, BookingTestData.BOOKING_ID, BookingTestData.PAYMENT_ID);
    }
    ...
    void onPaymentSucceeded_missing_paymentId_is_rejected() {
        ...
        try (ValidatorFactory factory = Validation.buildDefaultValidatorFactory()) {
            ...
            BookingEventConsumer realConsumer = new BookingEventConsumer(bookingService, new EventValidator(validator));
